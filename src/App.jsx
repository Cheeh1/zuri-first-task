  ...
  return (
    <div className='container'>
      ...
      <section className='links'>
        <a className='link-item' href="http://twitter.com/iamcheeh" target="_blank">
          <p className='link-txt'>Twitter Links </p>
        </a>

        <a className='link-item' id='btn__zuri' href="https://training.zuri.team/" target="_blank">
          <p className='link-txt'>Zuri Team</p>
        </a>

        <a className='link-item' id='books' href="http://books.zuri.team" target="_blank">
        ...
        <a className='link-item' id='pitch' href="https://background.zuri.team/" target="_blank">
          <p className='link-txt'>Background Checks for Coders</p>
        </a>
        
        <a className='link-item' id='book__design' href="https://books.zuri.team/design-rules" target="_blank">
